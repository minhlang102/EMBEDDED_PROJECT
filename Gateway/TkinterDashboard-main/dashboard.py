...
path = 'D:\\3rdYear\\IoT\\Gateway\\TkinterDashboard-main\\' #path to images folder

class Dashboard2:
    def __init__(self, window):
        self.window = window
        self.window.title("Gateway Management")
        self.window.geometry("1366x768")
        self.window.resizable(0, 0)
        self.window.state('zoomed')
        self.window.config(background='#eff5f6')
        # Window Icon Photo
        icon = PhotoImage(file=path + 'images\\pic-icon.png')
        ...
        # logo
        self.logoImage = ImageTk.PhotoImage(file=path + 'images\\hyy.png')
        ...
        # Dashboard
        self.dashboardImage = ImageTk.PhotoImage(file=path + 'images\\dashboard-icon.png')
        ...
        # Manage
        self.manageImage = ImageTk.PhotoImage(file=path + 'images\\manage-icon.png')
        ...
        # Settings
        self.settingsImage = ImageTk.PhotoImage(file=path + 'images\\settings-icon.png')
        ...
        # Exit
        self.ExitImage = ImageTk.PhotoImage(file=path + 'images\\exit-icon.png')
        ...
        # Body Frame 1
        self.pieChart_image = ImageTk.PhotoImage(file=path + 'images\\pie-graph1.png')
        self.pieChart = Label(self.bodyFrame1, image=self.pieChart_image, bg='#ffffff')
        self.pieChart.place(x=690, y=70)

        # Graph
        self.graph_image = ImageTk.PhotoImage(file=path + 'images\\graph.png')
        ...
        self.totalPeopleImage = ImageTk.PhotoImage(file=path + 'images\\left-icon.png')
        ...
        # left icon
        self.LeftImage = ImageTk.PhotoImage(file=path + 'images\\left-icon.png')
        ...
        # Frame 4 icon
        self.earningsIcon_image = ImageTk.PhotoImage(file=path + 'images\\earn3.png')
        ...
        # date and Time
        self.clock_image = ImageTk.PhotoImage(file="D:\\3rdYear\\IoT\\Gateway\\TkinterDashboard-main\\images\\time.png")
